...
### This is just MY config. All credit goes to the original creators.
...
```
yay -S --needed awesome rofi picom i3lock-fancy xclip ttf-roboto gnome-polkit materia-gtk-theme lxappearance flameshot pnmixer network-manager-applet xfce4-power-manager
wget -qO- https://git.io/papirus-icon-theme-install | sh
```
...
```
git clone https://github.com/ninja8247/material-awesome.git ~/.config/awesome
```
